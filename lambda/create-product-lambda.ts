...
import {productBodySchema} from "../shared/schema/schema";
...
export const handler: Handler = async (event: APIGatewayProxyEvent) => {
  try {
    const product: typeof productBodySchema = event.body ? JSON.parse(event.body) : {}
    ...
    console.log('Product was added successfully:', JSON.stringify(result, null, 2));
