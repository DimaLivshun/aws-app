...
export class AuthorizerStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const authorizerExampleLambdaFunction = new NodejsFunction(this, 'authorizer-example-lambda', {
...
// Authorizer
    ...
    const authorizerExampleLambdaIntegration = new apigateway.LambdaIntegration(authorizerExampleLambdaFunction, {
      requestTemplates: {
